...
Map<String, String> hindi = {
  ...
  "Didn't played yet": 'अभी तक नहीं बजाया',
  'Played': 'बजाया गया',
  'Settings': 'सेटिंग्स',
...
Map<String, String> bengali = {
  ...
  "Didn't played yet": 'এখনো বাজানো হয়নি',
  'Played': 'বাজানো হয়েছে',
  'Settings': 'সেটিংস',
  'Theme Brightness': 'থিম উজ্জ্বলতা',
  'System default': 'সিস্টেম ডিফল্ট',
  'Dark': 'ডার্ক',
  'Light': 'লাইট',
  'Quran Script Type': 'কোরআন স্ক্রিপ্ট প্রকার',
  'Quran Font Size': 'কোরআন ফন্ট সাইজ',
  'Translation Font Size': 'অনুবাদ ফন্ট সাইজ',
  'Book Name': 'বইয়ের নাম',
  'Author': 'লেখক',
  'Language': 'ভাষা',
  'Tafsir Book': 'তাফসীর বই',
  'Audio Cached': 'অডিও ক্যাশে করা হয়েছে',
  'Cache Not Found': 'ক্যাশে পাওয়া যায়নি',
...
Map<String, String> russian = {
  ...
  'System default': 'Системная настройка по умолчанию',
  'Dark': 'Темная',
  'Light': 'Светлая',
...
Map<String, String> japanese = {
  ...
  'Dark': 'ダーク',
  'Light': 'ライト',
  'Quran Script Type': 'コーラン スクリプト タイプ',
  'Quran Font Size': 'コーラン フォント サイズ',
  'Translation Font Size': '翻訳フォントサイズ',
  'Book Name': '本の名前',
  'Author': '著者',
  'Language': '言語',
  'Tafsir Book': 'タفسィール書',
  'Audio Cached': 'オーディオをキャッシュ済み',
...
Map<String, String> french = {
  ...
  "Didn't played yet": 'Pas encore joué',
  'Played': 'Joué',
  'Settings': 'Paramètres',
  ...
  'Dark': 'Sombre',
  'Light': 'Clair',
  'Quran Script Type': 'Type de script coranique',
  'Quran Font Size': 'Taille de la police coranique',
  'Translation Font Size': 'Taille de la police de traduction',
  'Book Name': 'Nom du livre',
  'Author': 'Auteur',
  'Language': 'Langue',
  'Tafsir Book': 'Livre de Tafsir',
  'Audio Cached': 'Audio mis en cache',
  'Cache Not Found': 'Cache non trouvée',
...
Map<String, String> indonesian = {
  ...
  'Dark': 'Gelap',
  'Light': 'Terang',
  'Quran Script Type': 'Jenis Tulisan Quran',
  'Quran Font Size': 'Ukuran Huruf Quran',
  'Translation Font Size': 'Ukuran Huruf Terjemahan',
  'Book Name': 'Nama Buku',
  'Author': 'Penulis',
  'Language': 'Bahasa',
  'Tafsir Book': 'Kitab Tafsir',
...
Map<String, String> swahili = {
  ...
  'Dark': 'Giza',
  'Light': 'Nuru',
  'Quran Script Type': 'Aina ya Hati ya Quran',
  'Quran Font Size': 'Ukubwa wa Fonti ya Quran',
...
Map<String, String> korean = {
  ...
  'Dark': '어둡게',
  'Light': '밝게',
  'Quran Script Type': '코란 스크립트 유형',
  'Quran Font Size': '코란 글꼴 크기',
...
Map<String, String> turkish = {
  ...
  'Dark': 'Koyu',
  'Light': 'Açık',
  'Quran Script Type': 'Kuran Yazı Tipi',
  'Quran Font Size': 'Kuran Yazı Boyutu',
...
Map<String, String> vietnamese = {
  ...
  'Dark': 'Tối',
  'Light': 'Sáng',
  'Quran Script Type': 'Loại chữ viết Kinh Qur\'an',
...
Map<String, String> italian = {
  ...
  'Dark': 'Scuro',
  'Light': 'Chiaro',
  'Quran Script Type': 'Tipo di script del Corano',
  'Quran Font Size': 'Dimensione del carattere del Corano',
  'Translation Font Size': 'Dimensione del carattere di traduzione',
  'Book Name': 'Nome del libro',
  'Author': 'Autore',
  'Language': 'Lingua',
  'Tafsir Book': 'Libro di Tafsir',
